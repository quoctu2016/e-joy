...
class Order extends \Eccube\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'pre_order_id', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'order_no', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'message', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'name01', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'name02', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'kana01', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'kana02', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'company_name', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'email', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'phone_number', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'postal_code', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'addr01', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'addr02', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'birth', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'subtotal', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'discount', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'delivery_fee_total', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'charge', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'tax', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'total', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'payment_total', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'payment_method', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'note', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'order_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'payment_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'currency_code', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'complete_message', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'complete_mail_message', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'OrderItems', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Shippings', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'MailHistories', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Customer', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Country', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Pref', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Sex', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Job', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Payment', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'DeviceType', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'CustomerOrderStatus', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'OrderStatusColor', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'OrderStatus', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'add_point', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'use_point', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'sample_payment_token', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'sample_payment_card_no_last4', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'SamplePaymentCvsType', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'SamplePaymentPaymentStatus', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'SamplePaymentCvsPaymentStatus'];
        }
  ...
  3 => 'AnnotationReader',
    ...
    public function getSamplePaymentToken()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSamplePaymentToken', []);

        return parent::getSamplePaymentToken();
    }
    ...
    public function setSamplePaymentToken($sample_payment_token)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSamplePaymentToken', [$sample_payment_token]);

        return parent::setSamplePaymentToken($sample_payment_token);
    }
    ...
    public function getSamplePaymentCardNoLast4()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSamplePaymentCardNoLast4', []);

        return parent::getSamplePaymentCardNoLast4();
    }
    ...
    public function setSamplePaymentCardNoLast4($sample_payment_card_no_last4)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSamplePaymentCardNoLast4', [$sample_payment_card_no_last4]);

        return parent::setSamplePaymentCardNoLast4($sample_payment_card_no_last4);
    }
    ...
    public function getSamplePaymentCvsType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSamplePaymentCvsType', []);

        return parent::getSamplePaymentCvsType();
    }

    /**
     * {@inheritDoc}
     */
    public function setSamplePaymentCvsType(\Plugin\SamplePayment\Entity\CvsType $SamplePaymentCvsType)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSamplePaymentCvsType', [$SamplePaymentCvsType]);

        return parent::setSamplePaymentCvsType($SamplePaymentCvsType);
    }
    ...
    public function getSamplePaymentPaymentStatus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSamplePaymentPaymentStatus', []);

        return parent::getSamplePaymentPaymentStatus();
    }

    /**
     * {@inheritDoc}
     */
    public function setSamplePaymentPaymentStatus(\Plugin\SamplePayment\Entity\PaymentStatus $SamplePaymentPaymentStatus = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSamplePaymentPaymentStatus', [$SamplePaymentPaymentStatus]);

        return parent::setSamplePaymentPaymentStatus($SamplePaymentPaymentStatus);
    }
    ...
    public function getSamplePaymentCvsPaymentStatus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSamplePaymentCvsPaymentStatus', []);

        return parent::getSamplePaymentCvsPaymentStatus();
    }

    /**
     * {@inheritDoc}
     */
    public function setSamplePaymentCvsPaymentStatus(\Plugin\SamplePayment\Entity\CvsPaymentStatus $SamplePaymentCvsPaymentStatus = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSamplePaymentCvsPaymentStatus', [$SamplePaymentCvsPaymentStatus]);

        return parent::setSamplePaymentCvsPaymentStatus($SamplePaymentCvsPaymentStatus);
    }
