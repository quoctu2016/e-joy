...
class Customer extends \Eccube\Entity\Customer implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['sample_payment_cards' => NULL];
    ...
    {
        unset($this->sample_payment_cards);
