...
// Returns the public 'Plugin\SamplePayment\Controller\Admin\ConfigController' shared autowired service.
...
include_once $this->targetDirs[3].'\\app\\Plugin\\SamplePayment\\Controller\\Admin\\ConfigController.php';

$this->services['Plugin\SamplePayment\Controller\Admin\ConfigController'] = $instance = new \Plugin\SamplePayment\Controller\Admin\ConfigController(${($_ = isset($this->services['Plugin\SamplePayment\Repository\ConfigRepository']) ? $this->services['Plugin\SamplePayment\Repository\ConfigRepository'] : $this->load('getConfigRepository2Service.php')) && false ?: '_'});
