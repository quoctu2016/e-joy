...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 'Plugin\\SamplePayment\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\SamplePayment\Form\Type\Admin\ConfigType']) ? $this->services['Plugin\SamplePayment\Form\Type\Admin\ConfigType'] : ($this->services['Plugin\SamplePayment\Form\Type\Admin\ConfigType'] = new \Plugin\SamplePayment\Form\Type\Admin\ConfigType())) && false ?: '_'};
}, 'Plugin\\SamplePayment\\Form\\Type\\Admin\\SearchPaymentType' => function () {
    return ${($_ = isset($this->services['Plugin\SamplePayment\Form\Type\Admin\SearchPaymentType']) ? $this->services['Plugin\SamplePayment\Form\Type\Admin\SearchPaymentType'] : ($this->services['Plugin\SamplePayment\Form\Type\Admin\SearchPaymentType'] = new \Plugin\SamplePayment\Form\Type\Admin\SearchPaymentType())) && false ?: '_'};
    ...
    yield 0 => ${($_ = isset($this->services['Plugin\SamplePayment\Form\Extension\CreditCardExtention']) ? $this->services['Plugin\SamplePayment\Form\Extension\CreditCardExtention'] : $this->load('getCreditCardExtentionService.php')) && false ?: '_'};
    yield 1 => ${($_ = isset($this->services['Plugin\SamplePayment\Form\Extension\CvsExtension']) ? $this->services['Plugin\SamplePayment\Form\Extension\CvsExtension'] : $this->load('getCvsExtensionService.php')) && false ?: '_'};
