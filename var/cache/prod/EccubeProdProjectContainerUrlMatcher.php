...
class EccubeProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/081097')) {
            // admin_login
            if ('/081097/login' === $pathinfo) {
            ...
            if (0 === strpos($pathinfo, '/081097/s')) {
                // admin_homepage_sale
                if ('/081097/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/081097/sample_payment')) {
                    // sample_payment_admin_config
                    if ('/081097/sample_payment/config' === $pathinfo) {
                        $ret = array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\Admin\\ConfigController::index',  '_route' => 'sample_payment_admin_config',);
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                                goto not_sample_payment_admin_config;
                            }

                            return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_admin_config', key($requiredSchemes)));
                        }

                        return $ret;
                    }
                    not_sample_payment_admin_config:

                    // sample_payment_admin_order_cancel
                    if (0 === strpos($pathinfo, '/081097/sample_payment/order/cancel') && preg_match('#^/081097/sample_payment/order/cancel/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sample_payment_admin_order_cancel']), array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\Admin\\OrderController::cancel',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        ...
                        if (!in_array($requestMethod, ['POST'])) {
                            ...
                            goto not_sample_payment_admin_order_cancel;
                        }
                        if (!$hasRequiredScheme) {
                            if ('GET' !== $canonicalMethod) {
                                goto not_sample_payment_admin_order_cancel;
                            ...
                            return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_admin_order_cancel', key($requiredSchemes)));
                        }

                        return $ret;
                    }
                    not_sample_payment_admin_order_cancel:

                    // sample_payment_admin_order_change_price
                    if (0 === strpos($pathinfo, '/081097/sample_payment/order/change_price') && preg_match('#^/081097/sample_payment/order/change_price/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sample_payment_admin_order_change_price']), array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\Admin\\OrderController::changePrice',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, ['POST'])) {
                            if ($hasRequiredScheme) {
                            ...
                            goto not_sample_payment_admin_order_change_price;
                        }
                        if (!$hasRequiredScheme) {
                            if ('GET' !== $canonicalMethod) {
                                goto not_sample_payment_admin_order_change_price;
                            ...
                            return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_admin_order_change_price', key($requiredSchemes)));
                        }

                        return $ret;
                    }
                    not_sample_payment_admin_order_change_price:

                    if (0 === strpos($pathinfo, '/081097/sample_payment/payment_status')) {
                        // sample_payment_admin_payment_status
                        if ('/081097/sample_payment/payment_status' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\Admin\\PaymentStatusController::index',  '_route' => 'sample_payment_admin_payment_status',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_sample_payment_admin_payment_status;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_admin_payment_status', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_sample_payment_admin_payment_status:

                        // sample_payment_admin_payment_status_pageno
                        if (preg_match('#^/081097/sample_payment/payment_status(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sample_payment_admin_payment_status_pageno']), array (  'page_no' => NULL,  '_controller' => 'Plugin\\SamplePayment\\Controller\\Admin\\PaymentStatusController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_sample_payment_admin_payment_status_pageno;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_admin_payment_status_pageno', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_sample_payment_admin_payment_status_pageno:

                        // sample_payment_admin_payment_status_bulk_action
                        if (0 === strpos($pathinfo, '/081097/sample_payment/payment_status/bulk_action') && preg_match('#^/081097/sample_payment/payment_status/bulk_action/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sample_payment_admin_payment_status_bulk_action']), array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\Admin\\PaymentStatusController::bulkAction',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, ['POST'])) {
                                if ($hasRequiredScheme) {
                                ...
                                goto not_sample_payment_admin_payment_status_bulk_action;
                            }
                            if (!$hasRequiredScheme) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_sample_payment_admin_payment_status_bulk_action;
                                ...
                                return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_admin_payment_status_bulk_action', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_sample_payment_admin_payment_status_bulk_action:

                    }

                }

                elseif (0 === strpos($pathinfo, '/081097/se')) {
                    // admin_homepage_nonstock
                    if ('/081097/search_nonstock' === $pathinfo) {
                    ...
                    if ('/081097/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/081097/setting/shop/csv') && preg_match('#^/081097/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/081097/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/081097/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/081097/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/081097/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/081097/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/081097/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/081097/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/081097/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/081097/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/081097/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/081097/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/081097/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/081097/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/081097/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/081097/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/081097/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/081097/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/081097/setting/system')) {
                        // admin_setting_system_authority
                        if ('/081097/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/081097/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/081097/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/081097/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/081097/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/081097/setting/system/member' === $pathinfo) {
                            ...
                            if ('/081097/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/081097/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/081097/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/081097/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/081097/setting/system/system' === $pathinfo) {
                            ...
                            if ('/081097/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/081097/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/081097/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/081097/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/shipping/preview_notify_mail') && preg_match('#^/081097/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/shipping/notify_mail') && preg_match('#^/081097/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/081097/store/plugin')) {
                    if (0 === strpos($pathinfo, '/081097/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/081097/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/081097/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/081097/store/plugin/api/search/page') && preg_match('#^/081097/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/081097/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/081097/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/store/plugin/api/delete') && preg_match('#^/081097/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/081097/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/081097/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/081097/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/081097/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/081097/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/081097/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/081097/store/template')) {
                    // admin_store_template
                    if ('/081097/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/081097/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/081097/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/081097/c')) {
                // admin_change_password
                if ('/081097/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/081097/content')) {
                    if (0 === strpos($pathinfo, '/081097/content/block')) {
                        // admin_content_block
                        if ('/081097/content/block' === $pathinfo) {
                        ...
                        if ('/081097/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/081097/content/cache' === $pathinfo) {
                    ...
                    // admin_content_css
                    if ('/081097/content/css' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/content/file_')) {
                        // admin_content_file
                        if ('/081097/content/file_manager' === $pathinfo) {
                        ...
                        if ('/081097/content/file_view' === $pathinfo) {
                        ...
                        if ('/081097/content/file_delete' === $pathinfo) {
                        ...
                        if ('/081097/content/file_download' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/content/layout')) {
                        // admin_content_layout
                        if ('/081097/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/081097/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/content/news')) {
                        // admin_content_news
                        if ('/081097/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/content/news/page') && preg_match('#^/081097/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/081097/content/page')) {
                        // admin_content_page
                        if ('/081097/content/page' === $pathinfo) {
                        ...
                        if ('/081097/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/081097/customer')) {
                    // admin_customer
                    if ('/081097/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/081097/customer/page') && preg_match('#^/081097/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/081097/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/081097/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/081097/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/081097/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/081097/order')) {
                // admin_shipping_csv_import
                if ('/081097/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/081097/order/csv_template' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/081097/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/081097/order/search')) {
                    if (0 === strpos($pathinfo, '/081097/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/081097/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/order/search/customer/html/page') && preg_match('#^/081097/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/081097/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/order/search/product')) {
                        // admin_order_search_product
                        if ('/081097/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/081097/order/search/product/page') && preg_match('#^/081097/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/081097/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/081097/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/081097/order/mail/view' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/081097/order/page') && preg_match('#^/081097/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/081097/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/081097/order/export')) {
                    // admin_order_export_order
                    if ('/081097/order/export/order' === $pathinfo) {
                    ...
                    if ('/081097/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/081097/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/081097/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/081097/product')) {
                if (0 === strpos($pathinfo, '/081097/product/c')) {
                    if (0 === strpos($pathinfo, '/081097/product/category')) {
                        // admin_product_category
                        if ('/081097/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/081097/product/category/export' === $pathinfo) {
                        ...
                        if ('/081097/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/081097/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/081097/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/081097/product/class_name')) {
                        // admin_product_class_name
                        if ('/081097/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/081097/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/081097/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/081097/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/081097/product/csv_template') && preg_match('#^/081097/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/081097/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/081097/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/081097/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/081097/product/page') && preg_match('#^/081097/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/081097/product/product')) {
                    // admin_product_image_add
                    if ('/081097/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/081097/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/081097/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/081097/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/081097/product/classes') && preg_match('#^/081097/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/081097/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/081097/product/bulk/product-status') && preg_match('#^/081097/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/081097/product/tag')) {
                    // admin_product_tag
                    if ('/081097/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/081097/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/081097/product/tag/sort_no/move' === $pathinfo) {
            ...
            if (0 === strpos($pathinfo, '/081097/related_product/search/product')) {
                // admin_related_product_search
                if ('/081097/related_product/search/product' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/081097/related_product/search/product/page') && preg_match('#^/081097/related_product/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
        ...
        elseif (0 === strpos($pathinfo, '/sample_payment_')) {
            // sample_payment_back
            if ('/sample_payment_back' === $pathinfo) {
                $ret = array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\PaymentController::back',  '_route' => 'sample_payment_back',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_sample_payment_back;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_back', key($requiredSchemes)));
                }

                return $ret;
            }
            not_sample_payment_back:

            // sample_payment_complete
            if ('/sample_payment_complete' === $pathinfo) {
                $ret = array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\PaymentController::complete',  '_route' => 'sample_payment_complete',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_sample_payment_complete;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_complete', key($requiredSchemes)));
                }

                return $ret;
            }
            not_sample_payment_complete:

            // sample_payment_receive_complete
            if ('/sample_payment_receive_complete' === $pathinfo) {
                $ret = array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\PaymentController::receiveComplete',  '_route' => 'sample_payment_receive_complete',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_sample_payment_receive_complete;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_receive_complete', key($requiredSchemes)));
                }

                return $ret;
            }
            not_sample_payment_receive_complete:

            // sample_payment_receive_cvs_status
            if ('/sample_payment_receive_cvs_status' === $pathinfo) {
                $ret = array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\PaymentController::receiveCvsStatus',  '_route' => 'sample_payment_receive_cvs_status',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_sample_payment_receive_cvs_status;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'sample_payment_receive_cvs_status', key($requiredSchemes)));
                }

                return $ret;
            }
            not_sample_payment_receive_cvs_status:
        ...
        // plugin_samplepayment_paymentcompany_index
        if ('/payment_company' === $pathinfo) {
            $ret = array (  '_controller' => 'Plugin\\SamplePayment\\Controller\\PaymentCompanyController::index',  '_route' => 'plugin_samplepayment_paymentcompany_index',);
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            if (!isset($requiredSchemes[$context->getScheme()])) {
                if ('GET' !== $canonicalMethod) {
                    goto not_plugin_samplepayment_paymentcompany_index;
                }

                return array_replace($ret, $this->redirect($rawPathinfo, 'plugin_samplepayment_paymentcompany_index', key($requiredSchemes)));
            }

            return $ret;
        }
        not_plugin_samplepayment_paymentcompany_index:
